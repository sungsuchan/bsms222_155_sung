...
![image](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-example-plot-1.png)
...
![image](https://rafalab.github.io/dsbook/R/img/ggplot2-cheatsheeta.png)
...
> Aesthetics
>
> geom_point understand the following aesthetics (required aesthetics are in bold):
>
> x
>
> y
...
and, as expected, we see that at least two argument are required ```x``` and ```y```.

## **7.4 Asethetic mappings**
...
This is preferred as it makes it easier to read the text. In Section 7.11 we learn a better way of assuring we can the points and the labels.
...
p + geom_point(size=3) +
  ...
  ggtitle("US Gun Merders in 2010")
```
