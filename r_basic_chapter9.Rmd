...
# **Chapter9 Data visualization in practice**
...
1. Has income inequality across countries worsened during the last 40 years?
...
1. Poland or South Korea
1. Malayia or Russia
1. Pakistan or Vietnam
1. Thailand or South Africa
...
gapminder %>% filter(year==2015,country%in%c("Sri Lanka","Poland","Malaysia","Pakistan","Thailand","Turkey","South Korea","Russia","Vietnam","South Africa")) %>% select(country,infant_mortality)
```
...
1. Life expectancy around 70years and 3 or fewer children per family.
1. Life expectancy lower than 65 years and more than 5 children per family.
...
gapminder %>%
  filter(year %in% years & continent %in% continents) %>% ggplot(aes(fertility,life_expectancy,col=continent)) + geom_point() + facet_wrap(~year)
```
