...
```{r}
data.frame(a=a,is_a_positive=a>0,answer1=1/a,answer2=NA)
...
my_function <- function(VARIABLE_NAME){
  perform operation on VARIABLE_NAME and calculate VALUE 
  VALUE
}
```
...
```{r, eval=FALSE}
The following objects are masked from 'package:stars':
